...
if (isset($_POST['submit_btn']) ){
  ...
  if (empty($email)){
    $error = true;
    $emailError = "Please provide a email.";
  }
                ...
                <form action="adminEDITMasterfile.php?id=<?php echo $idres;?>" method="POST" class="form-horizontal" enctype="multipart/form-data">
                  ...
                  <div class="control-group">
                    <label class="control-label">Email:</label>
                      <div class="controls">
                      <input type="text" class="span11" value="<?php echo $curremail;?>" name="email"/>
                        <!-- <span class ="label label-important"><?php echo $usernameError; ?></span> -->
                      </div>
                  </div>
              ...
              ?>
                          ...
                          <div class ="control-group">
                            <label class="control-label">Employment Type: </label>
                              <div class="controls">
                                <select name="employoption" id= "employoption" required onchange="updateDropdowns()">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <select name="shifttime" id="shifttime" required>
                        <option selected> <?php echo $currshiftsched; ?></option>
